...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MainSplitter.CreateView(
		0,
		1,
		RUNTIME_CLASS(CTool76View),
		CSize(WINCX, WINCY),
		pContext
		);
	...
	m_pMainView = (CTool76View*)m_MainSplitter.GetPane(0, 1);
...
//##화면 분할을 위해서 MainFrameClass를 초기화한다.
/*
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	// TODO: 여기에 특수화된 코드를 추가 및/또는 기본 클래스를 호출합니다.
	...
	return TRUE;
	//재귀함수형태로 지속적으로 호출되고 있기 때문에 화면분할을 할수가 없기 때문에
}*/
