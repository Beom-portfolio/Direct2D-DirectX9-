...
void CCreedWizard::Render(void)
{
	if (m_TargetCheck == true)
	{
		...
		float fY = CENTER_POS(pTargetTex->ImageInfo.Height) - 50;
...
void CCreedWizard::Release(void)
{
	safe_delete(m_pMonHpBar);
}

void CCreedWizard::AI(void)
{
...
void CCreedWizard::MonsterState(void)
{
	switch (m_eDir)
	{
	case DIR_U:
	...
	if (m_bChangeCheck == true)
	{
		...
		case MONSTER_STAND:
			...
			break;
		case MONSTER_WALK:
			m_wstrObjKey = L"C_WALK";
			m_tFrame = FRAME(0.f, 5.f, 5.f);
			break;
		case MONSTER_ATTACK:
			m_wstrObjKey = L"C_ATTACK";
			m_tFrame = FRAME(0.f, 15.f, 15.f);
			m_MonsterAttackCheck = true;
			break;
		case MONSTER_DAMAGE:
			break;
		case MONSTER_DIE:
			m_wstrObjKey = L"C_DEATH";
...
void CCreedWizard::MonsterDir(int MoveIndex)
{
...
void CCreedWizard::MyMatrixCheck(void)
{
	D3DXMATRIX matTrans;
	D3DXMATRIX matScale;
...
void CCreedWizard::AStarMove(void)
{
...
void CCreedWizard::MyFrameCheck(void)
{
	if (m_bAttachCheck == true)
	{
		...
		if (m_tFrame.fIndex >= 12.f && m_MonsterAttackCheck == true)
		{
...
void CCreedWizard::MonsterDamage(void)
{
