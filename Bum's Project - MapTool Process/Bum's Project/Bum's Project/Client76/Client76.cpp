// Client76.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_CLIENT76, szWindowClass, MAX_LOADSTRING);
	...
	while(msg.message != WM_QUIT)
	{
		...
		else
		{
			...
			if (pFrame_Manager->Permit_Call(L"Frame_200", fTimeDelta_Default))
			{
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_CLIENT76));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= NULL;//MAKEINTRESOURCE(IDC_CLIENT76);
