...
void CDarkCow::Release(void)
{
	safe_delete(m_pMonHpBar);
}

void CDarkCow::AI(void)
{
...
void CDarkCow::MonsterState(void)
{
	switch (m_eDir)
	{
	case DIR_U:
...
void CDarkCow::MonsterDir(int MoveIndex)
{
...
void CDarkCow::MyMatrixCheck(void)
{
	D3DXMATRIX matTrans;
	D3DXMATRIX matScale;
...
void CDarkCow::MyFrameCheck(void)
{
	if (m_bAttachCheck == true)
	{
		...
		if (m_tFrame.fIndex >= 7.f && m_MonsterAttackCheck == true)
		{
...
void CDarkCow::MonsterDamage(void)
{
